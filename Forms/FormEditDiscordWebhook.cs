...
namespace PlenBotLogUploader
{
    public partial class FormEditDiscordWebhook : Form
    {
        ...
        private void FormEditDiscordWebhook_FormClosing(object sender, FormClosingEventArgs e)
        {
            ...
            {
                DiscordWebhookDataSuccessToggle successFailToggle = DiscordWebhookDataSuccessToggle.OnSuccessAndFailure;
                ...
                {
                    DiscordWebhookData webhook = allWebhooks[reservedId];
        ...
        private List<int> ConvertCheckboxListToList()
        {
            ...
            {
                object item = checkedListBoxBossesEnable.Items[i];
                if (item.GetType().Equals(typeof(BossesDisableHelperClass)))
                {
                    BossesDisableHelperClass bossEnableHelper = (BossesDisableHelperClass)item;
                    bool checkedState = checkedListBoxBossesEnable.GetItemChecked(i);
                    if (!checkedState)
                    {
